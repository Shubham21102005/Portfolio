...
const projects = [
  {
    ...
    link: "https://github.com/Shubham21102005/codebase-intelligence-platform",
  },
  {
  ...
  },
  {
    ...
    link: "https://github.com/Shubham21102005/AI_Mock_interview_Platform",
  },
  {
          ...
          <div className="overflow-x-auto pb-4 scrollbar-hide">
            <div className="flex gap-6 min-w-max">
              {projects.map((project, index) => (
                <div
                  key={index}
                  className="border border-zinc-800 rounded-lg p-6 hover:border-blue-500 transition-colors w-80 flex flex-col flex-shrink-0"
                >
